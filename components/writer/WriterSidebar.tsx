      ...
      >
        <Link href="/" className="flex items-center gap-2">
          <Image
            ...
            className="object-contain"
          />
          <span className="text-sm font-bold text-[var(--text-primary)]">Writer</span>
        </Link>
        ...
        {WRITER_NAV.map(({ href, icon: Icon, label, exact }) => {
          ...
          return (
            <Link
              ...
              style={{ color: active ? "#059669" : "var(--text-tertiary)" }}
            >
              {active && (
                <span
        ...
        <>
          ...
          >
            <div className="flex items-center justify-between mb-4">
              <p className="text-xs font-bold uppercase tracking-widest text-[var(--text-tertiary)]">Writer Menu</p>
              <button
                onClick={() => setMoreOpen(false)}
